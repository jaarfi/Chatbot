    ...
    if chat_message.startswith("gpt"):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a twitch chatbot, answering questions in text-to-speech. Do not use any profane language. You answer questions as though you are a real person with opinions",
                },
                {"role": "user", "content": "Whats your favorite anime?"},
                {
                    "role": "assistant",
                    "content": "That's obviously Tengen Toppa Gurren Lagann.",
                },
